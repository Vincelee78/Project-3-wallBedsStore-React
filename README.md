...
| I log in with my email and password| After I log on, I am redirected to the catalogue page where the images of the products are with a confirmation message 'Login sucessful, (myemail)'). If my entered my email or password wrongly, I would get an error message saying 'login failed!'|
